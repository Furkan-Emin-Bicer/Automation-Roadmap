...
class LoginPage:
    ...
    def check(self):
        ...
        (self.methods.wait_element_visible(self.EMAIL_CONTINE), 'No "Contine" button on the page!')
    ...
    def sign_in(self, email, password):
        ...
        self.methods.wait_element_clickable(self.EMAIL_CONTINE).click()
